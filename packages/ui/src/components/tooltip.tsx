    ...
    <TooltipPrimitive.Portal>
      ...
      >
        <TooltipPrimitive.Popup
          ...
          className={cn(
            'z-50 inline-flex w-fit max-w-xs origin-(--transform-origin) items-center gap-1.5 rounded-lg bg-foreground px-3 py-1.5 text-xs text-background transition-[opacity,scale] duration-150 ease-out-quart has-data-[slot=kbd]:pr-1.5 data-starting-style:scale-[0.96] data-starting-style:opacity-0 data-ending-style:scale-[0.96] data-ending-style:opacity-0 data-ending-style:duration-100 motion-reduce:transition-none **:data-[slot=kbd]:relative **:data-[slot=kbd]:isolate **:data-[slot=kbd]:z-50 **:data-[slot=kbd]:rounded-lg',
            className,
          )}
          {...props}
        >
