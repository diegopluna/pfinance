...
| `WEB_DOMAIN`                              | Unset                                                             | Custom domain for the web app ([quickstart step 8](/guides/quickstart/#8-production-urls-optional)). Attached as a Cloudflare custom domain — DNS and certificate are managed for you; the hostname's zone must already exist in your account. Becomes the app's primary URL and the default `WEB_ORIGIN`.                               |
...
| `DOCS_DOMAIN`                             | Unset                                                             | Custom domain for your instance's copy of this docs site, same mechanics as `WEB_DOMAIN`.                                                                                                                                                                                                                                                |
