  ...
  return (
    <AlertDialogPortal>
      ...
      <AlertDialogPrimitive.Popup
        ...
        data-size={size}
        className={cn(
          'group/alert-dialog-content fixed top-1/2 left-1/2 z-50 grid w-full -translate-x-1/2 -translate-y-1/2 gap-6 rounded-xl bg-popover p-6 text-popover-foreground shadow-xl ring-1 ring-foreground/5 outline-none transition-[opacity,scale,filter] duration-200 ease-out-quart data-[size=default]:max-w-xs data-[size=sm]:max-w-xs data-[size=default]:sm:max-w-md dark:ring-foreground/10 data-starting-style:scale-[0.96] data-starting-style:opacity-0 data-starting-style:blur-[4px] data-ending-style:scale-[0.96] data-ending-style:opacity-0 data-ending-style:blur-[4px] data-ending-style:duration-150 motion-reduce:transition-none',
          className,
        )}
        {...props}
      />
